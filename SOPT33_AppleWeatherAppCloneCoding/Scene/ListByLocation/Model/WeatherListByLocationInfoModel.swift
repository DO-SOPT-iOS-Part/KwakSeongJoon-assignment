    ...
    static func dummy() -> [WeatherDataStruct] {
        [
            WeatherDataStruct(locationName: "나의 위치", locationTimeOrMyLocation: "서울특별시", locationWeather: "흐림", locationTemperature: 18, locationHighestTemp: 30, locationLowestTemp: 12, weatherDescription: "00:00~02:00에 강우 상태가, 18:00에 한 때 흐린 상태가 예상됩니다.", detailWeatherByHour: [
                ...
                TendayWeatherInfo(day: "오늘", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 13, weatherProgressImage: .rainyAfterSunny, highTemp: 27),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 14, weatherProgressImage: .rainyAfterSunny, highTemp: 29),
                TendayWeatherInfo(day: "화", weatherImage: .rainy, rainyPercent: 60, lowTemp: 15, weatherProgressImage: .rainyAfterSunny, highTemp: 24),
                TendayWeatherInfo(day: "수", weatherImage: .rainy, rainyPercent: 70, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 21),
                TendayWeatherInfo(day: "목", weatherImage: .rainy, rainyPercent: 40, lowTemp: 17, weatherProgressImage: .rainyAfterSunny, highTemp: 35),
                TendayWeatherInfo(day: "금", weatherImage: .rainy, rainyPercent: 20, lowTemp: 18, weatherProgressImage: .rainyAfterSunny, highTemp: 26),
            ...
            WeatherDataStruct(locationName: "목동", locationTimeOrMyLocation: "01:00", locationWeather: "흐림", locationTemperature: 19, locationHighestTemp: 32, locationLowestTemp: 12, weatherDescription: "00:00~02:00에 강우 상태가, 18:00에 한 때 흐린 상태가 예상됩니다.", detailWeatherByHour: [
                ...
                TendayWeatherInfo(day: "오늘", weatherImage: .rainy, rainyPercent: 20, lowTemp: 13, weatherProgressImage: .rainyAfterSunny, highTemp: 41),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 14, weatherProgressImage: .rainyAfterSunny, highTemp: 25),
                TendayWeatherInfo(day: "화", weatherImage: .rainy, rainyPercent: 60, lowTemp: 15, weatherProgressImage: .rainyAfterSunny, highTemp: 26),
                TendayWeatherInfo(day: "수", weatherImage: .rainy, rainyPercent: 70, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 24),
                TendayWeatherInfo(day: "목", weatherImage: .rainy, rainyPercent: 40, lowTemp: 17, weatherProgressImage: .rainyAfterSunny, highTemp: 25),
            ...
            WeatherDataStruct(locationName: "인천", locationTimeOrMyLocation: "01:00", locationWeather: "맑아짐", locationTemperature: 20, locationHighestTemp: 34, locationLowestTemp: 12, weatherDescription: "00:00~02:00에 강우 상태가, 18:00에 한 때 흐린 상태가 예상됩니다.", detailWeatherByHour: [
                ...
                TendayWeatherInfo(day: "오늘", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 13, weatherProgressImage: .rainyAfterSunny, highTemp: 41),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 14, weatherProgressImage: .rainyAfterSunny, highTemp: 62),
                TendayWeatherInfo(day: "화", weatherImage: .cloudy, rainyPercent: 60, lowTemp: 15, weatherProgressImage: .rainyAfterSunny, highTemp: 93),
                TendayWeatherInfo(day: "수", weatherImage: .rainy, rainyPercent: 70, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 24),
                TendayWeatherInfo(day: "목", weatherImage: .rainy, rainyPercent: 40, lowTemp: 17, weatherProgressImage: .rainyAfterSunny, highTemp: 25),
                TendayWeatherInfo(day: "금", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 18, weatherProgressImage: .rainyAfterSunny, highTemp: 26),
                TendayWeatherInfo(day: "토", weatherImage: .rainy, rainyPercent: 40, lowTemp: 19, weatherProgressImage: .rainyAfterSunny, highTemp: 27),
                TendayWeatherInfo(day: "일", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 15, weatherProgressImage: .rainyAfterSunny, highTemp: 88),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 29),
                TendayWeatherInfo(day: "화", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 17, weatherProgressImage: .rainyAfterSunny, highTemp: 30),
                TendayWeatherInfo(day: "수", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 18, weatherProgressImage: .rainyAfterSunny, highTemp: 31)
            ]),
            WeatherDataStruct(locationName: "부산", locationTimeOrMyLocation: "01:00", locationWeather: "천둥", locationTemperature: 21, locationHighestTemp: 36, locationLowestTemp: 12, weatherDescription: "00:00~02:00에 강우 상태가, 18:00에 한 때 흐린 상태가 예상됩니다.", detailWeatherByHour: [
                ...
                TendayWeatherInfo(day: "오늘", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 23, weatherProgressImage: .rainyAfterSunny, highTemp: 21),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 14, weatherProgressImage: .rainyAfterSunny, highTemp: 22),
                TendayWeatherInfo(day: "화", weatherImage: .rainy, rainyPercent: 10, lowTemp: 35, weatherProgressImage: .rainyAfterSunny, highTemp: 23),
                TendayWeatherInfo(day: "수", weatherImage: .rainy, rainyPercent: 20, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 24),
                TendayWeatherInfo(day: "목", weatherImage: .rainy, rainyPercent: 30, lowTemp: 67, weatherProgressImage: .rainyAfterSunny, highTemp: 25),
                TendayWeatherInfo(day: "금", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 18, weatherProgressImage: .rainyAfterSunny, highTemp: 26),
                TendayWeatherInfo(day: "토", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 19, weatherProgressImage: .rainyAfterSunny, highTemp: 27),
                TendayWeatherInfo(day: "일", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 15, weatherProgressImage: .rainyAfterSunny, highTemp: 28),
                TendayWeatherInfo(day: "월", weatherImage: .cloudy, rainyPercent: nil, lowTemp: 16, weatherProgressImage: .rainyAfterSunny, highTemp: 29),
