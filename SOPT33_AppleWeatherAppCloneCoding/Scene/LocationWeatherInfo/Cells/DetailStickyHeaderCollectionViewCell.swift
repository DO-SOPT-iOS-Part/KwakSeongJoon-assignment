//
//  DetailStickyHeaderCollectionViewCell.swift
...
final class DetailStickyHeaderCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "DetailStickyHeaderCollectionViewCell"
    ...
    private func setLayout() {
        ...
        self.contentView.addSubviews(locationNameLabel, tempAndWeatherInfoStackView)
